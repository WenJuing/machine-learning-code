...
from layers import DropPath, LayerNorm2d, get_norm_layer, NormMlpClassifierHead, ClassifierHead, checkpoint_seq
...
def davit_large(num_classes: int = 1000, **kwargs):
    model = DaViT(
        depths=(1, 1, 9, 1),
...
def davit_huge(num_classes: int = 1000, **kwargs):
    model = DaViT(
        depths=(1, 1, 9, 1),
...
def davit_giant(num_classes: int = 1000, **kwargs):
    model = DaViT(
        depths=(1, 1, 12, 3),
