...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default="SwinV2-T")
    ...
    parser.add_argument('--weights', type=str, default='D:/weights/swin_transformer_v2/swinv2_tiny_patch4_window8_256.pth',
