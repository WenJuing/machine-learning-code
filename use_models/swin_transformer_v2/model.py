...
# 官方github中没有提供 SwinV2-H 和 SwinV2-G的相关参数和预训练权重
# 更多模型变体见：
# https://github.com/microsoft/Swin-Transformer
# 补充：window size部分很奇怪
# 官方给的 window size=8的模型，实际要window size=7才可以运行；而window size=12的模型，实际要window size=14
# 但这样就无法使用预训练权重了（预训练权重中的window size是8/12）
...
def swinv2_large_patch4_window12_192_22k(num_classes: int = 1000, **kwargs):
