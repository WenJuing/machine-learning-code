...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default="Swin-T")
    ...
    parser.add_argument('--weights', type=str, default='D:/weights/swin_transformer/swin_tiny_patch4_window7_224.pth',
