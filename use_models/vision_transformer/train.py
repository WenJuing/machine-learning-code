...
def main(args):
    ...
    # 使用torchvision提供的数据集
    # train_dataset = FashionMNIST("./data/FashionMNIST", train=True, transform=data_transform["train"], download=False)
    # val_dataset = FashionMNIST("./data/FashionMNIST", train=False, transform=data_transform["val"], download=False)
